                ...
                <div className="w-1/2 rounded shadow-2xl p-8 m-4">
                    ...
                    <form action="/" method="post">
                        ...
                        <div className="flex flex-col mb-4">
                            ...
                            <select className="select select-primary w-full max-w-xl my-1 cursor-pointer" name='loction' id='location'>
                                <option disabled selected>Enter Your Location</option>
                        ...
                        <div className="flex flex-col mb-4">
                            ...
                            <label class="input-group input-group-md">
                                <input type="text" value="0.099" class="input my-1 input-bordered input-primary w-full max-w-xl" />
